...
export default function TenantAdminCourseRecordingsPage() {
    ...
    >
      {() => (
        <CourseWorkspacePlaceholder
          title="Recordings isn't available yet"
          description="Recorded session playback for this course will live here in a later release."
        />
      )}
    </CourseWorkspaceShell>
  );
